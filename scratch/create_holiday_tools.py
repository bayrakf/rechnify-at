...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Brückentage-Planer {COUNTRY_NAME} – Urlaub verdoppeln | rechnify.at</title>
  <meta name="description" content="Nutze Brückentage clever! Finde heraus, wie du in {COUNTRY_NAME} mit minimalen Urlaubstagen die meiste freie Zeit herausholst." />
  ...
  <meta property="og:type" content="website" />
  <meta property="og:title" content="Brückentage-Planer {COUNTRY_NAME} | rechnify.at" />
  <meta property="og:description" content="Verdopple deinen Urlaub mit cleveren Brückentagen." />
...
<body>
  ...
  <nav class="breadcrumb" aria-label="Breadcrumb">
    ...
    <a href="/#arbeitszeit">Arbeitszeit</a>
    <span class="breadcrumb-sep">›</span>
    <span class="breadcrumb-current">Brückentage</span>
  </nav>

  <main class="site-main">
    
    <div class="page-hero" style="padding-top:10px;">
      <h1 style="margin-bottom:8px;">Brückentage-Planer {COUNTRY_NAME}</h1>
